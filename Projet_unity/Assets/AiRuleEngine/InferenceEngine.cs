	...
	public class InferenceEngine : MonoBehaviour
	{
		...
		void Update()
		{
			if(!Chargement_jeu.waiting)
			{
				...
				{
					if (m_TimeSinceLastTick * 2000 > m_RuleBaseTick && this.gameObject.GetComponent<Element>().camp == "Ours")
					{
				...
				{
					if (m_TimeSinceLastTick * 2000 > m_RuleBaseTick && this.gameObject.GetComponent<Element>().camp == "Poulpe")
					{
						m_RuleBase.DebugMessage("Tick Rulebase");
